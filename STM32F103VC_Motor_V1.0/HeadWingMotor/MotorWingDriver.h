...
#define GET_LIMIT_WING_L 		HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_15)	//左翅限位器
#define GET_LIMIT_WING_R  	HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_8) 	//右翅限位器
/****************************************************
