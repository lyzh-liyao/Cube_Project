...
#define HEAD_MAX_PWM 3600			//头部速度最大PWM
...
#define GET_LIMIT_HEAD_L 			HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_15)	//左头限位器
#define GET_LIMIT_HEAD_R  			HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_12)	//右头限位器
#define GET_ENC_HEAD_A 			HAL_GPIO_ReadPin(GPIOC, H_ENC_A_PIN)	//头部A项编码器
#define GET_ENC_HEAD_B 			HAL_GPIO_ReadPin(GPIOD, H_ENC_B_PIN)	//头部B项编码器
